...
const get_standard_deviation = (data_array: number[]) => {
...
const get_time_diff = (date_from: Date, date_to: Date) => (date_to.getTime() - date_from.getTime()) / 1000;
...
const create_report = (data_logs: data_log[],  data_info: DataInfo) : EAPCReport => {
